...
const Dashboard = () => {
  ...
  const getCurrentPageTitle = () => {
    ...
    switch (location.pathname) {
      ...
      case '/dashboard/schedules': return 'Schedules';
          ...
          {showMobileMenu && (
            <>
              ...
              <motion.div
                ...
                className="fixed left-0 top-0 bottom-0 z-50 w-72 bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl shadow-2xl lg:hidden"
              >
                {/* Menu Header */}
        ...
        <main className="flex-1 overflow-y-auto pb-20 lg:pb-8">
          <div className="px-4 lg:px-6 py-4 lg:py-6">
            <Routes>
              ...
              <Route path="/community" element={<div className="p-8 bg-white dark:bg-gray-800 rounded-2xl shadow-lg"><h2 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white">Community</h2><p className="text-gray-600 dark:text-gray-400">Community features will appear here.</p></div>} />
              <Route path="/chat" element={<div className="p-8 bg-white dark:bg-gray-800 rounded-2xl shadow-lg"><h2 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white">Chat & Support</h2><p className="text-gray-600 dark:text-gray-400">Chat functionality will appear here.</p></div>} />
              ...
              <Route path="/coach/*" element={<div className="p-8 bg-white dark:bg-gray-800 rounded-2xl shadow-lg"><h2 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white">Coach Dashboard</h2><p className="text-gray-600 dark:text-gray-400">Coach features will appear here.</p></div>} />
              <Route path="/admin/*" element={<div className="p-8 bg-white dark:bg-gray-800 rounded-2xl shadow-lg"><h2 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white">Admin Panel</h2><p className="text-gray-600 dark:text-gray-400">Admin features will appear here.</p></div>} />
